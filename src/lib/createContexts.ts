...
export const createContexts = (options: {
	...
	const internalCtx: ThrelteInternalContext = {
		...
		collectDisposableObjects: (object, objects) => {
			const disposables: DisposableObject[] = objects ?? []
